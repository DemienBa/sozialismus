...
const PARAMETER_L2_BASE = [
  // STRATEGIE (Dachgeschoss)
  { id: '00', feld: 'STRATEGIE', titel: 'REFORM/REVOLUTION', kurz: 'Wie überwinden wir den Kapitalismus?', links: 'Strikte Reform', rechts: 'Revolution', icon: '🛤️' },
  { id: '12', feld: 'STRATEGIE', titel: 'STAAT', kurz: 'Wie stehen wir zum Staat?', links: 'Staat erobern', rechts: 'Staat abschaffen', icon: '🏴' },
  { id: '17', feld: 'STRATEGIE', titel: 'THEORIE', kurz: 'Welche Theorie leitet uns?', links: 'Hist. Materialismus', rechts: 'Präfigurativ', icon: '📚' },
  { id: '22', feld: 'STRATEGIE', titel: 'WANDEL', kurz: 'Wie kommt der Wandel?', links: 'Reform', rechts: 'Revolution', icon: '🔄' },
  { id: '23', feld: 'STRATEGIE', titel: 'GESCHICHTE', kurz: 'Wie mit linker Geschichte umgehen?', links: 'Kritisch', rechts: 'Verteidigen', icon: '📜' },
  // ÖKONOMIE (Erdgeschoss)
  { id: '01', feld: 'ÖKONOMIE', titel: 'EIGENTUM', kurz: 'Wem gehören Produktionsmittel?', links: 'Staatsbesitz', rechts: 'Commons', icon: '🏭' },
  { id: '02', feld: 'ÖKONOMIE', titel: 'PLANUNG', kurz: 'Wie Wirtschaft koordinieren?', links: 'Reg. Markt', rechts: 'Vollplanung', icon: '📊' },
  { id: '05', feld: 'ÖKONOMIE', titel: 'ORGANISATION', kurz: 'Wie sollte die Linke organisiert sein?', links: 'Kaderpartei', rechts: 'Basisdemokratie', icon: '🏛️' },
  { id: '16', feld: 'ÖKONOMIE', titel: 'ARBEIT', kurz: 'Was ist das Ziel bei Arbeit?', links: 'Vollbeschäftigung', rechts: 'Post-Work', icon: '⏰' },
  { id: '20', feld: 'ÖKONOMIE', titel: 'DIGITALITÄT', kurz: 'Wie mit Big Tech umgehen?', links: 'Commons', rechts: 'Innovation', icon: '💻' },
  // SOZIALES (Erster Stock)
  { id: '03', feld: 'SOZIALES', titel: 'SOZIALSTAAT', kurz: 'Wie soziale Sicherheit?', links: 'BGE für alle', rechts: 'Aktivierend', icon: '🏠' },
  { id: '04', feld: 'SOZIALES', titel: 'STEUERN', kurz: 'Wie stark umverteilen?', links: 'Radikal', rechts: 'Niedrig', icon: '💰' },
  { id: '06', feld: 'SOZIALES', titel: 'AKTIONSFORM', kurz: 'Wie kommt gesellschaftlicher Wandel?', links: 'Parlament', rechts: 'Direkte Aktion', icon: '✊' },
  { id: '07', feld: 'SOZIALES', titel: 'PRAXIS', kurz: 'Was ist die wichtigste Form linker Praxis?', links: 'Intellektuell', rechts: 'Militant', icon: '📖' },
  { id: '14', feld: 'SOZIALES', titel: 'KULTURKAMPF', kurz: 'Klasse oder Identität?', links: 'Klasse zuerst', rechts: 'Identität', icon: '🎭' },
  // GESELLSCHAFT (Souterrain)
  { id: '08', feld: 'GESELLSCHAFT', titel: 'ÖKOLOGIE', kurz: 'Wie Klimakrise lösen?', links: 'Ökomodernismus', rechts: 'Tiefenökologie', icon: '🌍' },
  { id: '09', feld: 'GESELLSCHAFT', titel: 'SUBJEKT', kurz: 'Wer kann die Gesellschaft verändern?', links: 'Arbeiterklasse', rechts: 'Alles Leben', icon: '👥' },
  { id: '10', feld: 'GESELLSCHAFT', titel: 'ANTIRASSISMUS', kurz: 'Ansatz gegen Rassismus?', links: 'Dekolonial', rechts: 'Integration', icon: '✊🏿' },
  { id: '11', feld: 'GESELLSCHAFT', titel: 'TECHNOLOGIE', kurz: 'Welche Rolle spielt Tech?', links: 'Tech-Skepsis', rechts: 'Akzelerationismus', icon: '🤖' },
  { id: '21', feld: 'GESELLSCHAFT', titel: 'CARE', kurz: 'Wie Sorgearbeit organisieren?', links: 'Vergesellschaftung', rechts: 'Wahlfreiheit', icon: '💜' },
  { id: '25', feld: 'GESELLSCHAFT', titel: 'ZUKUNFT', kurz: 'Wie blickst du in die Zukunft?', links: 'Pessimismus', rechts: 'Utopie', icon: '🔮' },
  // INTERNATIONAL (Keller)
  { id: '13', feld: 'INTERNATIONAL', titel: 'INTERNATIONALISMUS', kurz: 'Auf welcher Ebene kämpfen?', links: 'Lokal', rechts: 'Planetar', icon: '🌍' },
  { id: '15', feld: 'INTERNATIONAL', titel: 'EU', kurz: 'Wie zur EU stehen?', links: 'Lexit', rechts: 'Föderales Europa', icon: '🇪🇺' },
  { id: '18', feld: 'INTERNATIONAL', titel: 'NAHOST', kurz: 'Wie zum Nahost-Konflikt stehen?', links: 'Pro-Palästina', rechts: 'Pro-Israel', icon: '☮️' },
  { id: '19', feld: 'INTERNATIONAL', titel: 'MIGRATION', kurz: 'Wie offen Grenzen?', links: 'Offene Grenzen', rechts: 'Gesteuert', icon: '🌐' },
  { id: '24', feld: 'INTERNATIONAL', titel: 'GEOPOLITIK', kurz: 'Geopolitische Position?', links: 'Linker Nationalismus', rechts: 'No Border', icon: '🗺️' },
];
...
// NEUER ALGORITHMUS: Fokussiert auf die Achsen, bei denen der User von 3 abweicht
const getOfflineAnalyseL2 = (antworten, analysen) => {
  if (!analysen?.archetypen) return null;
  
  // Finde Achsen wo der User von der Mitte (3) abweicht
  const userAbweichungen = {};
  for (const [paramId, value] of Object.entries(antworten)) {
    if (value !== 3) {
      userAbweichungen[paramId] = value;
    }
  }
  
  // Wenn User alles auf 3 hat, suche nach "namenlos" Archetyp oder gib generische Antwort
  const hatAbweichungen = Object.keys(userAbweichungen).length > 0;
  
  if (!hatAbweichungen) {
    // Suche nach "namenlos" oder ähnlichem Archetyp
    const namenlos = analysen.archetypen.find(a => 
      a.id === 'namenlos' || 
      a.id === 'ambivalent' || 
      a.archetyp?.toLowerCase().includes('namenlos') ||
      a.archetyp?.toLowerCase().includes('ambivalent') ||
      a.archetyp?.toLowerCase().includes('undogmatisch')
    );
    
    if (namenlos) {
      console.log('Alle Werte auf Mitte - wähle namenlos:', namenlos.archetyp);
      return {
        id: namenlos.id,
        archetyp: namenlos.archetyp,
        beschreibung: namenlos.beschreibung || "Du positionierst dich bewusst in der Mitte – oder hast dich noch nicht entschieden. Das ist keine Schwäche: Ambivalenz kann Offenheit bedeuten.",
        theoretiker: namenlos.theoretiker,
        staerken: namenlos.staerken,
        spannungen: namenlos.spannungen,
        slogan: namenlos.slogan || "Die Wahrheit liegt nicht immer in der Mitte – aber manchmal im Fragen.",
        emoji: namenlos.emoji || "🌫️",
        gewichte: namenlos.gewichte || {},
        ideal: namenlos.ideal || {}
      };
    }
    
    // Fallback: Berechne Distanz zu ALLEN Ideal-Werten (nicht nur Abweichungen)
    console.log('Alle Werte auf Mitte - kein namenlos gefunden, berechne volle Distanz');
  }
  ...
  for (const arch of analysen.archetypen) {
    ...
    if (hatAbweichungen) {
      // NUR die User-Abweichungen zählen für die Distanz
      for (const [paramId, userValue] of Object.entries(userAbweichungen)) {
        const idealValue = arch.ideal[paramId] || 3;
        const weight = arch.gewichte?.[paramId] || 5;
      ...
      // User hat alles auf 3 - berechne Distanz zu ALLEN Ideal-Werten
      // Archetypen mit extremeren Ideal-Werten bekommen höhere Distanz
      for (const [paramId, idealValue] of Object.entries(arch.ideal)) {
        const userValue = 3; // Alles auf Mitte
  ...
  console.log('User-Abweichungen:', userAbweichungen);
          ...
          {loading ? (
            ...
            <>
              ...
              <div style={{ marginTop: '2rem' }}>
                ...
                <div 
                  onClick={() => {
                    // Baue URL nur mit Profil - Haus berechnet Rest selbst
                    let wesenPath = 'haus/index.html';
                    const params = new URLSearchParams();
                    
                    // Profil: direkt Haus-IDs (00:3,01:5,02:2,...)
...
const App = () => {
  ...
  useEffect(() => {
    Promise.all([
      ...
      // Profil aus URL übernehmen (Format: 00:5,01:3,...)
      if (profilParam) {
        console.log('📥 Profil aus URL empfangen:', profilParam);
        const profilObj = {};
        profilParam.split(',').forEach(pair => {
          const [achse, wert] = pair.split(':');
          if (achse && wert) {
            profilObj[achse.trim()] = parseInt(wert.trim());
          }
        });
        
        // Speichere im localStorage für Layer 2
        localStorage.setItem('savedL2Antworten', JSON.stringify(profilObj));
        console.log('💾 Profil gespeichert:', profilObj);
        console.log('📊 Anzahl Achsen:', Object.keys(profilObj).length);
      }
  ...
  // Debug: Zeige Parameter-Anzahl
  console.log('paramsL2 Anzahl:', paramsL2?.length, 'IDs:', paramsL2?.map(p => p.id).join(','));
